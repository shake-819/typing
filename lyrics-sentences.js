...
const LYRICS_SONGS = [
  ...
  },
  {
    ...
    lines: [
      ...
      { display: "今泣いて何分か後に行く", kana: "いまないてなんぷんかごにいく" },
      { display: "今泣いて何分か後の自分", kana: "いまないてなんぷんかごのじぶん" },
      { display: "今泣いて何分か後に行く", kana: "いまないてなんぷんかごにいく" },
      { display: "今泣いて何分か後に言う", kana: "いまないてなんぷんかごにいう" },
      { display: "今泣いて何年か後の自分", kana: "いまないてなんねんかごのじぶん" },
      ...
      { display: "雨になって何分か後に行く", kana: "あめになってなんぷんかごにいく" },
      { display: "今泣いて何分か後に行く", kana: "いまないてなんぷんかごにいく" },
      { display: "今泣いて何分か後の自分", kana: "いまないてなんぷんかごのじぶん" },
      { display: "今泣いて何分か後に言う", kana: "いまないてなんぷんかごにいう" },
      { display: "今泣いて何年か後の自分", kana: "いまないてなんねんかごのじぶん" },
  ...
  },
  {
    ...
    lines: [
      ...
      { display: "この愛は Crazy", kana: "このあいは くれいじー" },
      ...
      { display: "片付けられない This feeling", kana: "かたづけられない でぃす ふぃーりんぐ" },
